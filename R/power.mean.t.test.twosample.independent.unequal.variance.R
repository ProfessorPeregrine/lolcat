...
# Same two-sided pattern (Welch df / ncp = d).
# -----------------------------------------------------------------------------
power.mean.t.test.twosample.independent.unequal.variance <- function(
  ...
  df <- (variance.est.g1 / sample.size.g1 + variance.est.g2 / sample.size.g2)^2 /
    ((variance.est.g1 / sample.size.g1)^2 / (sample.size.g1 - 1) +
       (variance.est.g2 / sample.size.g2)^2 / (sample.size.g2 - 1))
  ncp <- d
